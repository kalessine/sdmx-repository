...
import sdmx.repository.sdmx.entities.Language;
...
public class LanguageUtil {
    ...
    public static sdmx.repository.sdmx.entities.Language EN = new sdmx.repository.sdmx.entities.Language();

    public static sdmx.repository.sdmx.entities.Language FR = new sdmx.repository.sdmx.entities.Language();
