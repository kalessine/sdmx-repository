 ...
 * @author James
 */
public class DatabaseRepository implements WritableRepository {
    ...
    public Dataset getVTLDataset(String name) {
        Dataflow d = DataflowUtil.findDataflow(em, "VTL".toString(), name, "1.0");
        if(d!=null){
    ...
    public void setVTLDataset(String name, Dataset ds) {
        Dataflow d = DataflowUtil.findDataflow(em, "VTL".toString(), name, "1.0");
        if(d==null){
            fr.insee.vtl.model.Structured structed = ds;
