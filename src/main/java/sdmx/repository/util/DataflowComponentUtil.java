...
public class DataflowComponentUtil {
    ...
    public static sdmx.repository.entities.DataflowComponent createDatabaseDataflowComponent(EntityManager em, Dataflow df, Component comp, int pos) {
        sdmx.repository.entities.DataflowComponent dfc = new sdmx.repository.entities.DataflowComponent();
    ...
    public static List<sdmx.repository.entities.DataflowComponent> searchDataflowComponent(EntityManager em, Long df) {
        try {
            Query q = em.createQuery("select d from DataflowComponent d where d.dataflowComponentPK.dataflow=:df");
            q.setParameter("df", df);
            sdmx.repository.entities.DataflowComponent dfc = null;
            List<sdmx.repository.entities.DataflowComponent> list = q.getResultList();
            return list;
        } catch (Exception ex) {
            ex.printStackTrace();
            return null;
    ...
    public static List<sdmx.repository.entities.DataflowComponent> searchDataflowComponent(EntityManager em, Long df, int type) {
        try {
    ...
    public static sdmx.repository.entities.DataflowComponent findDataflowComponent(EntityManager em, Long df, String id) {
        try {
    ...
    public static sdmx.repository.entities.DataflowComponent findDataflowComponent(EntityManager em, sdmx.repository.entities.Dataflow df, String id) {
        try {
            Query q = em.createQuery("select d from DataflowComponent d where d.dataflowComponentPK.dataflow=:df and d.dataflowComponentPK.columnId=:id");
            q.setParameter("df", df);
            q.setParameter("id", id);
